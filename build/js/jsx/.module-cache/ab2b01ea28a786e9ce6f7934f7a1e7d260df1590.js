...
var SelectQuestionType = React.createClass({displayName: "SelectQuestionType",
	...
	handleSelectType:function(key) {
		this.setState({curType:quiestionTypes.values[key]});
	},
	...
	render:function() {
		...
		Object.keys(quiestionTypes.values).forEach(function(k){
			...
			//list.push(<li onClick={this.handleSelect} key={k} id={k}><a href="#">{quiestionTypes.values[k]}</a></li>);
			count++;
		}.bind(this));
		...
		return (
			React.createElement("div", {className: "btn-group"}, 
				React.createElement("button", {type: "button", className: "btn btn-primary"}, quiestionTypes.values[this.state.curType]), 
