	...
	render:function() {
		return (
			React.createElement("div", {className: "menu all"}, 
				React.createElement("img", null, React.createElement("i", {className: "fa fa-file-image-o fa-2x menu-item", alt: "TEST"})), 
				React.createElement("i", {className: "fa fa-cubes fa-2x menu-item", alt: "TEST"})
			)
		);
	}
})
