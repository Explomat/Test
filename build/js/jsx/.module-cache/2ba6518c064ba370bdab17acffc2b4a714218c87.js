...
var QuestionType = React.createClass({displayName: "QuestionType",
	...
	getInitialState:function() {
		return {
			isTypeDisplay:false,
			curType:"Единственный выбор"
		}
	},

	render:function() {
		var isShowPlacesAndEventForms = { display: this.state.eventTypes.defaultValue.name == "Вебинар" ? "none":"block" }

		var isTypeDisplayStyle = { display: this.state.isTypeDisplay ? "block":"none" };
		return (
			React.createElement("div", {className: "btn-group"}, 
				React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.handleSelect}, this.state.curType), 
