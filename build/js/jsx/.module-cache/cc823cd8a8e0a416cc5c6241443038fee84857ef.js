...
var QuestionType = React.createClass({displayName: "QuestionType",
	...
	render:function() {
		...
		Object.keys(quiestionTypes.values).forEach(function(k){
			if (count % 2 == 0)
				list.push(React.createElement("li", {className: "divider"}));
			else
				list.push(React.createElement("li", {key: k}, React.createElement("a", {href: "#"}, quiestionTypes.values[k])));
			count++;
		});
		/*quiestionTypes.toArray().forEach(function(l){
			Object.keys(this.values)
			//list.push(<li><a href="#">{}</a></li>);
		}.bind(this));*/
		return (
			React.createElement("div", {className: "btn-group"}, 
				React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.handleSelect}, quiestionTypes.values[this.state.curType]), 
