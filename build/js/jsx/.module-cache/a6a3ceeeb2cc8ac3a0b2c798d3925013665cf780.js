	...
	render:function() {
		...
		return (
			React.createElement("div", {className: "btn-group select-qtype", tabIndex: "0"}, 
				...
				React.createElement("button", {type: "button", className: "btn btn-default dropdown-toggle qtype-btnn", onClick: this.handleDisplayTypes, onBlur: this.handleBlurTypes}, 
