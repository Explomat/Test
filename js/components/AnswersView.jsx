			...
			<BaseAnswerView uuid={this.props.uuid} number={this.props.number} handleToogleExpand={this.handleToogleExpand} expanded={this.props.expanded}>
				<div className="answer__content">
					<Drop.DropInfo ref="dropInfo" onExpand={this.handleExpand} descriptionMarkup={descriptionMarkup} expanded={this.props.expanded}>
						...
						<Drop.DropInfoBody>
							<TextView className={"answer__text"} value={this.props.text} onBlur={this.changeText} placeholder="Пояснение *" focused={this.props.focused}/>
			...
			<BaseAnswerView uuid={this.props.uuid} number={this.props.number} handleToogleExpand={this.handleToogleExpand} expanded={this.props.expanded}>
				<div className="answer__content">
					<Drop.DropInfo ref="dropInfo" onExpand={this.handleExpand} descriptionMarkup={descriptionMarkup} expanded={this.props.expanded}>
						...
						<Drop.DropInfoBody>
							<TextView className={"answer__text"} value={this.props.text} onBlur={this.changeText} placeholder="Ответ *" focused={this.props.focused}/>
