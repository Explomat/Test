...
var SelectQuestionType = React.createClass({displayName: "SelectQuestionType",
	...
	render:function() {
		...
		return (
			React.createElement("div", {className: "btn-group select-qtype"}, 
				React.createElement("button", {type: "button", className: "btn btn-default qtype-btn"}, 
					quiestionTypes.values[this.state.qType]
				), 

				React.createElement("button", {className: "btn btn-default dropdown-toggle", type: "button"}, "Dropdown Example", 
			    	React.createElement("span", {className: "caret"})
			    ), 
				React.createElement("button", {className: "btn btn-primary dropdown-toggle", type: "button", onClick: this.handleDisplayTypes}, 
					React.createElement("span", {className: "caret"})
				), 
