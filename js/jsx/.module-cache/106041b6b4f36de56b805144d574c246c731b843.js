	...
	render:function() {
		...
		return (
			React.createElement("div", {className: "btn-group select-qtype"}, 
				React.createElement("button", {className: "btn btn-default dropdown-toggle", type: "button", onClick: this.handleDisplayTypes}, 
					React.createElement("span", null, quiestionTypes.values[this.state.qType], "    "), 
